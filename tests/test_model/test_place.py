...
class PlaceInstantiationTest(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        bm_str = bm.__str__()
        self.assertIn("[Place] (123)", bm_str)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_str = dt.isoformat()
        bm = Place(id="123", created_at=dt_str, updated_at=dt_str)
    ...
    def test_none_kwarg_args(self):
        with self.assertRaises(TypeError):
            bm = Place(id=None, created_at=None, updated_at=None)

    def test_instance_with_arg_and_kwarg(self):
        dt = datetime.today()
        dt_str = dt.isoformat()
        bm = Place("12", id="123", created_at=dt_str, updated_at=dt_str)
        self.assertEqual(bm.id, "123")
        self.assertEqual(bm.created_at, dt)
        self.assertEqual(bm.updated_at, dt)
